...
class Text{
    static function limitChar($content, $limit) {
    ...
    static function left($string,$left){
      return substr($string,$left*-1);
    }

    static function right($string,$right){
      return substr($string,0,$right);
    }
